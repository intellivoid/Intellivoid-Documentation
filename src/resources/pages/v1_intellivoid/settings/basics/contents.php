        ...
        <div id="main-wrapper">
            ...
            <div class="page-wrapper">
                <div class="container-fluid">
                            ...
                            <div class="card" id="authentication">
                                <div class="card-body">
                                    ...
                                    <div>
                                        ...
                                        for more information see <a href="<?PHP DynamicalWeb::getRoute("v1_intellivoid/coa/introduction") ?>">COA API Introduction</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card" id="error_codes">
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        error codes work see <a href="<?PHP DynamicalWeb::getRoute("v1_intellivoid/error_codes", [], true); ?>">Intellivoid - Error Codes</a>
                                        <br/><br/>
                    ...
                    <div class="row">
                        <button class="right-side-toggle waves-effect waves-light <?PHP theme_ButtonInfo(); ?> btn btn-circle btn-sm pull-right" onclick="location.href='<?PHP DynamicalWeb::getRoute('v1_intellivoid/settings/data_types', [] ,true); ?>';">
