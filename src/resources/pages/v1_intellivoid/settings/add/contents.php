        ...
        <div id="main-wrapper">
            ...
            <div class="page-wrapper">
                <div class="container-fluid">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div id="success_response">
                                        ...
                                        <a href="<?PHP DynamicalWeb::getRoute("v1_intellivoid/settings/summary", [], true); ?>">Application Settings - Get Summary</a>
                    ...
                    <div class="row">
                        <button class="right-side-toggle waves-effect waves-light <?PHP theme_ButtonInfo(); ?> btn btn-circle btn-sm pull-right" onclick="location.href='<?PHP DynamicalWeb::getRoute('v1_intellivoid/settings/get', [] ,true); ?>';">
