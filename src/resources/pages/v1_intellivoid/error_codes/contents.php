                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        in <a href="<?PHP DynamicalWeb::getRoute("v1_intellivoid/coa/basics", [], true); ?>#error_codes">COA API Basics - Error Codes</a>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <ul class="list-icons">
                                            ...
                                            <li>
                                                <i class="ti-angle-right"></i>
                                                <a href="<?PHP DynamicalWeb::getRoute("v1_intellivoid/coa/basics", [], true); ?>#error_codes" class="<?PHP theme_TextColor(); ?>">COA</a>
                                            </li>
                                            <li>
                                                <i class="ti-angle-right"></i>
                                                <a href="<?PHP DynamicalWeb::getRoute("v1_intellivoid/settings/basics", [], true); ?>#error_codes" class="<?PHP theme_TextColor(); ?>">SETTINGS</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <hr/>
