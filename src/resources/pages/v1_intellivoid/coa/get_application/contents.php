        ...
        <div id="main-wrapper">
            ...
            <div class="page-wrapper">
                <div class="container-fluid">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div>
                                        ...
                                        view the errors section in <a href="<?PHP DynamicalWeb::getRoute("v1_intellivoid/coa/introduction") ?>">COA API Basics</a>
                    ...
                    <div class="row">
                        <button class="right-side-toggle waves-effect waves-light <?PHP theme_ButtonInfo(); ?> btn btn-circle btn-sm pull-right" onclick="location.href='<?PHP DynamicalWeb::getRoute('v1_intellivoid/coa/request_authentication', [] ,true); ?>';">
