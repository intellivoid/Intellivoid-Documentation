        ...
        <div id="main-wrapper">
            ...
            <div class="page-wrapper">
                <div class="container-fluid">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    require a Request Token to perform this request, see <a href="<?PHP DynamicalWeb::getRoute("v1_intellivoid/coa/request_authentication", [], true); ?>">Request Authentication</a>
                    ...
                    <div class="row">
                        <button class="right-side-toggle waves-effect waves-light <?PHP theme_ButtonInfo(); ?> btn btn-circle btn-sm pull-right" onclick="location.href='<?PHP DynamicalWeb::getRoute('v1_intellivoid/coa/get_access_token', [] ,true); ?>';">
