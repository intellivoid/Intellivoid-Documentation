        ...
        <div id="main-wrapper">
            ...
            <div class="page-wrapper">
                <div class="container-fluid">
                        ...
                        <div class="col-lg-7 col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <a href="<?PHP DynamicalWeb::getRoute("v1_intellivoid/application/introduction", [], true); ?>">Introduction to Applications</a>, if you want to know how you can
                                    authenticate see <a href="<?PHP DynamicalWeb::getRoute("v1_intellivoid/coa/basics", [], true); ?>">COA API Basics</a>
                                    <hr/>
                                    ...
                                    <ul class="list-icons pt-3">
                                        <li>
                                            ...
                                            <a href="<?PHP DynamicalWeb::getRoute("v1_intellivoid/coa/request_authentication", [], true); ?>" class="<?PHP theme_TextColor(); ?>">Requesting Authentication</a>
                                        </li>
                                        <li>
                                            <i class="ti-angle-right"></i>
                                            <a href="<?PHP DynamicalWeb::getRoute("v1_intellivoid/coa/process_authentication", [], true); ?>" class="<?PHP theme_TextColor(); ?>">Process Authentication</a>
                                        </li>
                                    </ul>
                    ...
                    <div class="row">
                        <button class="right-side-toggle waves-effect waves-light <?PHP theme_ButtonInfo(); ?> btn btn-circle btn-sm pull-right" onclick="location.href='<?PHP DynamicalWeb::getRoute('v1_intellivoid/coa/basics', [] ,true); ?>';">
