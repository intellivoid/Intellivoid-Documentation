...
<html lang="<?PHP HTML::print(APP_LANGUAGE_ISO_639); ?>">
    ...
    <head>
        ...
        <?PHP
            renderMetaTags(
                "Accounts API - Basics",
                "An introduction on how the Accounts API Works"
            );
        ?>
    </head>
                ...
                <div class="container-fluid">
                    <div class="row page-titles">
                        <div class="align-self-center">
                            <h3 class="text-themecolor m-b-0 m-t-0 pt-2">Accounts API - Basics</h3>
                            <ol class="breadcrumb">
                            ...
                            <div class="card" id="authentication">
                                <div class="card-body">
                                    ...
                                    <div>
                                        ...
                                        for more information see <a href="<?PHP DynamicalWeb::getRoute("v1_intellivoid/coa/introduction", [], true); ?>">COA API Introduction</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card" id="error_codes">
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <a href="<?PHP DynamicalWeb::getRoute("v1_intellivoid/coa/basics", [], true); ?>#error_codes">COA Error Codes</a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <button class="right-side-toggle waves-effect waves-light <?PHP theme_ButtonInfo(); ?> btn btn-circle btn-sm pull-right" onclick="location.href='<?PHP DynamicalWeb::getRoute('v1_intellivoid/accounts/get_user', [] ,true); ?>';">
