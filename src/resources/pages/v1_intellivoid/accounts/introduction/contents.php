        ...
        <div id="main-wrapper">
            ...
            <div class="page-wrapper">
                <div class="container-fluid">
                        ...
                        <div class="col-lg-7 col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    information, to learn how to do that see <a href="<?PHP DynamicalWeb::getRoute("v1_intellivoid/coa/introduction", [], true); ?>">COA Introduction</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <button class="right-side-toggle waves-effect waves-light <?PHP theme_ButtonInfo(); ?> btn btn-circle btn-sm pull-right" onclick="location.href='<?PHP DynamicalWeb::getRoute('v1_intellivoid/accounts/basics', [] ,true); ?>';">
