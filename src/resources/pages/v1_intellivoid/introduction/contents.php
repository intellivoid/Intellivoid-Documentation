                                        ...
                                        <div class="col-lg-8">
                                            ...
                                            <ul class="list-icons pt-3">
                                                <li>
                                                    ...
                                                    <a href="<?PHP DynamicalWeb::getRoute("v1_intellivoid/application/introduction", [], true); ?>" class="<?PHP theme_TextColor(); ?>">Introduction to Applications</a>
                                                </li>
                                                <li>
                                                    <i class="ti-angle-right"></i>
                                                    <a href="<?PHP DynamicalWeb::getRoute("v1_intellivoid/coa/introduction", [], true); ?>" class="<?PHP theme_TextColor(); ?>">COA Introduction</a>
                                                </li>
                                                <li>
                                                    <i class="ti-angle-right"></i>
                                                    <a href="<?PHP DynamicalWeb::getRoute("v1_intellivoid/accounts/introduction", [], true); ?>" class="<?PHP theme_TextColor(); ?>">Accounts Introduction</a>
                                                </li>
                                                <li>
                                                    <i class="ti-angle-right"></i>
                                                    <a href="<?PHP DynamicalWeb::getRoute("v1_intellivoid/settings/introduction", [], true); ?>" class="<?PHP theme_TextColor(); ?>">Application Settings Introduction</a>
                                                </li>
                                            </ul>
                                        </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <ul class="pt-3">
                                        ...
                                        <li>
                                            <a href="<?PHP DynamicalWeb::getRoute("v1_intellivoid/application/introduction", [], true); ?>" target="_blank">Introduction to Applications</a>
                                        </li>
                                        <li>
                                            <a href="<?PHP DynamicalWeb::getRoute("v1_intellivoid/application/authentication_methods", [], true); ?>" target="_blank">Application Authentication Methods</a>
                                        </li>
                                        <li>
                                            <a href="<?PHP DynamicalWeb::getRoute("v1_intellivoid/coa/introduction", [], true); ?>" target="_blank">Cross-over Authentication Introduction</a>
                                        </li>
                                        <li>
                                            <a href="<?PHP DynamicalWeb::getRoute("v1_intellivoid/accounts/introduction", [], true); ?>" target="_blank">Accounts Introduction</a>
                                        </li>
                                        <li>
                                            <a href="<?PHP DynamicalWeb::getRoute("v1_intellivoid/settings/introduction", [], true); ?>" target="_blank">Appliication Settings/Variables Introduction</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
