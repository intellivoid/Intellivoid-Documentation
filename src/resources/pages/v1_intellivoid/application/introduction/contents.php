        ...
        <div id="main-wrapper">
            ...
            <div class="page-wrapper">
                <div class="container-fluid">
                        ...
                        <div class="col-lg-7 col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    learn how it works and how to use it see <a href="<?PHP DynamicalWeb::getRoute("v1_intellivoid/coa/introduction", [], true); ?>">COA API Introduction</a>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <ul class="pt-3">
                                        ...
                                        <li>
                                            <a href="<?PHP DynamicalWeb::getRoute("v1_intellivoid/application/permissions", [], true); ?>" target="_blank">Application Permissions</a>
                                        </li>
                                        <li>
                    ...
                    <div class="row">
                        <button class="right-side-toggle waves-effect waves-light <?PHP theme_ButtonInfo(); ?> btn btn-circle btn-sm pull-right" onclick="location.href='<?PHP DynamicalWeb::getRoute('v1_intellivoid/application/permissions', [] ,true); ?>';">
