                        ...
                        <div class="col-12">
                            <div class="card" id="placeholder">
                                <div class="card-body">
                                    ...
                                    Your client first <a href="<?PHP DynamicalWeb::getRoute("v1_intellivoid/coa/request_authentication", [] ,true); ?>">requests authentication</a>,
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-lg-8">
                                            ...
                                            <a href="<?PHP DynamicalWeb::getRoute("v1_intellivoid/coa/process_authentication", [] ,true); ?>">Process Authentication</a>
                                            method and wait till the user authenticates using the URL that the server
                                            provided. As soon as the user authenticates the <a href="<?PHP DynamicalWeb::getRoute("v1_intellivoid/coa/process_authentication", [] ,true); ?>">Process Authentication</a>
                        ...
                        <div class="col-12">
                            <div class="card" id="code">
                                <div class="card-body">
                                    ...
                                    <a href="<?PHP DynamicalWeb::getRoute("v1_intellivoid/coa/request_authentication", [] ,true); ?>">request authentication</a>
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-lg-8">
                                            ...
                                            with <a href="<?PHP DynamicalWeb::getRoute("v1_intellivoid/coa/process_authentication", [] ,true); ?>">Process Authentication</a>
