                            ...
                            <div class="card" id="error_codes">
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        and some are specific to the front-end for the user, the two sets are seperated.
                                    </div>
                                    <hr/>

                                    <div id="clientside">
                                        <h4>COA Error codes (Client-side)</h4>
                                        These are errors that you would recieve on COA's API, your client should expect
                                        these errors.
                                        <br/><br/>
                                    ...
                                    <div id="frontend">
                                        ...
                                        These are errors that a user would recieve on the front-end when using the
